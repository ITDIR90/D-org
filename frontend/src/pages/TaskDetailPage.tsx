    ...
    <div>
      ...
      <div className="card">
        <div className="detail-grid">
          <div className="detail-item"><label>Номер / Оформлена</label><span><span className="task-number-chip">№{task.number}</span> <span style={{ color: 'var(--color-text-secondary)' }}>{formatDate(task.created_at)}</span></span></div>
